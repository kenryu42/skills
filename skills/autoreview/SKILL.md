...
- Review bundles fail closed before engine invocation on binary, gitlink, symlink, non-UTF-8, oversized, or unreadable inputs. Safe large diffs are scanned in full, sent as one pass while they fit the aggregate prompt limit, then partitioned into complete bounded passes without truncation.
